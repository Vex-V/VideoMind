...
stages specified in Section~5. The job reports its stage --- fetching, chunking,
analyzing, indexing, aggregating, complete --- and the client polls it, reconciling the
