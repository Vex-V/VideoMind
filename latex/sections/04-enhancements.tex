...
same chunk cannot be the same person --- \emph{before} an LLM writes any narrative.
...
counter was present throughout'' is true of every frame and informs no search; and
