...
The MDX documentation site, covering concepts, workspace guides and the complete API
reference, together with the public landing pages. \\
Phase 8 & Hardening and reporting &
Execution of the acceptance test cases in Section~9 against a live server, the automated
suites that support them, error handling, deployment, and this document. \\
\bottomrule
\end{tabularx}
\end{table}
...
\midrule
Avinash Anish &
\textbf{Application tier and ingestion.} The entire interface, covering authentication,
