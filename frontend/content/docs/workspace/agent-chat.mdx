...
The model picker sits above the input. Providers are OpenAI, Google, Groq and Cerebras; the list
lives in `app/agent/lib/ai/models.ts` and any model whose provider key is set can be selected.
